...
namespace PortfolioServer.Test.Shifts
{
    public class DeleteShiftTests
    {
        ...
        public async Task ReturnsBadRequestWithNoId()
        {
            ...
            var function = new DeleteShift(shiftService, AuthenticationHelperMock.GetAuthenticationHelper());
        ...
        public async Task ReturnsNotFoundWithBadId()
        {
            ...
            shiftServiceMock.Setup(s => s.DeleteShift(AuthenticationHelperMock.GoodUserId, testId)).ReturnsAsync(false);
        ...
        public async Task ReturnsOkWithGoodId()
        {
            ...
            var shiftServiceMock = new Mock<IShiftService>(MockBehavior.Strict);
            shiftServiceMock.Setup(s => s.DeleteShift(AuthenticationHelperMock.GoodUserId, testShift.Id)).ReturnsAsync(true);
            var shiftService = shiftServiceMock.Object;
            ...
            shiftServiceMock.Verify(s => s.DeleteShift(AuthenticationHelperMock.GoodUserId, testShift.Id));
        }
